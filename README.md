...
[Kliknij tutaj, aby dodać listę do adblocka](abp:subscribe?location=https%3A%2F%2Fraw.githubusercontent.com%2Frokartur%2Fpolish-complete-filters%2Fmain%2Fpolish-complete-filters.txt&title=Polish%20Complete%20Filters)
### Aby dodać listę ręcznie:

1. Otwórz ustawienia swojego adblockera
    
2. Przejdź do sekcji **Własne filtry / Custom filters**
    
3. Dodaj powyższy adres URL
...
Repozytorium przygotowywane jest pod **automatyczne aktualizacje filtrów**.

Docelowo skrypt będzie:
...
Dzięki temu lista filtrów będzie **zawsze aktualna**.
...
Lista projektów, które mogą być wykorzystywane jako źródła filtrów:

### Polish Ads Filter (MajkiIT)

Oficjalne polskie filtry dla AdBlock, uBlock Origin i AdGuard.

[https://github.com/MajkiIT/polish-ads-filter](https://github.com/MajkiIT/polish-ads-filter)
...
[https://github.com/FiltersHeroes/PolishAnnoyanceFilters](https://github.com/FiltersHeroes/PolishAnnoyanceFilters)
...
[https://github.com/FiltersHeroes/KAD](https://github.com/FiltersHeroes/KAD)
